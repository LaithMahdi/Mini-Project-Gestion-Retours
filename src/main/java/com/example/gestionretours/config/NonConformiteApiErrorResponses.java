...
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "400",
                description = "Bad Request - Invalid non-conformite payload",
                content = @Content(
        ...
        @ApiResponse(
                responseCode = "403",
                description = "Forbidden - User role cannot access non-conformite endpoint",
                content = @Content(
                        schema = @Schema(implementation = ApiErrorResponse.class),
...
public @interface NonConformiteApiErrorResponses {
}
