...
import EtatTraitementButton from "./EtatTraitementButton";
...
export const columns: ColumnDef<Item>[] = [
  ...
  {
    accessorKey: "client",
    header: () => <div className="text-base">Client</div>,
    cell: ({ row }) => (
  ...
  {
    accessorKey: "produit",
    header: () => <div className="text-base">Produit</div>,
    cell: ({ row }) => (
  ...
  {
    accessorKey: "raison",
    header: () => <div className="text-base">Raison</div>,
    cell: ({ row }) => (
      <DescriptionTooltip title="Raison" description={row.original.raison} />
    ),
  },
  {
    accessorKey: "etatTraitement",
    header: () => <div className="text-base">Etat</div>,
    cell: ({ row }) => (
      <EtatTraitementButton
        id={row.original.id}
        etatTraitement={row.original.etatTraitement}
      />
    ),
  },
  {
