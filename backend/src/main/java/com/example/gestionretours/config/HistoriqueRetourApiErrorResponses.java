...
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "400",
                description = "Bad Request - Invalid historique retour payload",
                content = @Content(
        ...
        @ApiResponse(
                responseCode = "403",
                description = "Forbidden - User role cannot access historique endpoint",
                content = @Content(
                        schema = @Schema(implementation = ApiErrorResponse.class),
...
public @interface HistoriqueRetourApiErrorResponses {
}
